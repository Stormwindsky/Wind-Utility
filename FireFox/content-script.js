// content-script.js - VERSION COMPLÈTE AVEC TOUTES LES FONCTIONNALITÉS
...
async function initializeFeatures() {
    ...
    const settings = await new Promise(resolve => {
        browserAPI.storage.local.get(['iaSummarizerEnabled', 'gamejoltCleanerEnabled', 'gamejoltPayToWinEnabled'], resolve);
    });
