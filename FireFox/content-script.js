// content-script.js - VERSION COMPLÈTE CORRIGÉE
...
function showSummaryPopup(content, isError = false) {
    ...
    closeButton.onmouseout = () => closeButton.style.backgroundColor = '#666';
    ...
    `;
    closeXButton.onclick = () => popup.remove();
...
// Lancement immédiat - plus besoin d'ouvrir le menu
initContentScript();
