// settings.js - VERSION COMPLÈTE AVEC OPTION GAMEJOLT ET NO MORE PAY TO WIN
...
function loadSettings() {
    browserAPI.storage.local.get(['iaSummarizerEnabled', 'gamejoltCleanerEnabled', 'gamejoltPayToWinEnabled'], (data) => {
...
// 3. TOGGLE NO MORE PAY TO WIN (NOUVELLE FONCTIONNALITÉ)
